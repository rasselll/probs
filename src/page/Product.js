      ...
      <Container style={{backgroundColor: '#fdfdfd'}}>
        ...
        <Content>
          ...
          <View style={{marginTop: 15, paddingLeft: 12, paddingRight: 12}}>
            ...
            <Image source={{uri: 'http://res.cloudinary.com/atf19/image/upload/c_crop,g_face,h_250,x_248/v1500465308/fashion-men-s-individuality-black-and-white-157675_wnctss.jpg'}} style={{width: Dimensions.get('window').width, height: 350}} resizeMode="cover"/>
          </View>
        </Content>
      </Container>
    );
